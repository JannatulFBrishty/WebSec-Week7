...
While working on this assignment, I start to appreciate more of the time, efforts, and ingenuities that these security engineers had expended to find these vulnerabilities. I do not think that a regular user will have the time or imagination to go through convoluted steps to end up breaking the website that they are visiting. But again, we should never underestimate our own ability to do such thing. 

In addition, most of the vulnerabilities listed by `wpscan` do not contain much (if any) information on how to recreate them. I would assume that those vulnerabilities were discovered as part of a non-disclosure agreements between the engineers and WP.  

## License

    Copyright 2017 Ichwan Palongengi
